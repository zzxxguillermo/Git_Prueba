...
def aplicar_iva_10(precio_base2):
    impuesto2 = precio_base2 * 0.10
    precio_final2 = precio_base2 + impuesto2
    return precio_final2  # Devolvemos el total para usarlo afuera
...
# Pedimos el dato (usamos float para que acepte números con decimales)
monto2 = float(input("Ingrese el precio del producto: $"))

# Llamamos a la función pasando el monto ingresado y guardamos el resultado
total_a_cobrar2 = aplicar_iva_10(monto2)
